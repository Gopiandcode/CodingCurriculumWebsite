...
public class TestCaseContainer {
	...
	String name = "Remaining items";
	
	public TestCaseContainer(){
		
		cases.add(new TestQuestion("Ruby", 600, 40,new Ruby()));
		cases.add(new TestQuestion("Stone", 600, 40,new Stone()));
		cases.add(new TestQuestion("Diamond", 600, 40,new Diamond()));
	}
